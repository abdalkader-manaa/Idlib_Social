...
searchPosts.oninput = function searchOfPost() {
  Posts.forEach((ele) => {
    ...
    if (
      ele.children[0].children[0].children[1].children[0].innerHTML
        .toLowerCase()
        .startsWith(searchPosts.value.toLowerCase())
    ) {
  ...
  allMessages.forEach((ele) => {
    ...
    if (
      ele.children[1].children[0].innerHTML
        .toLowerCase()
        .startsWith(searchMessages.value.toLowerCase())
    ) {
...
let fontSizeProgress = document.querySelectorAll(
  ".theme .font-size .progres span"
);
...
window.onresize = () => {
  let fontSizeData = document.querySelector(
    ".theme .font-size .progres span.active"
  );
...
function changeColor() {
  let primary;
  let colorOptionDone = document.querySelectorAll(
    ".color .color-options span.active"
  )[0];
  if (
    colorOptionDone ==
    document.querySelector(".color .color-options span:nth-child(1)")
  ) {
    primary = 252;
  }
  if (
    colorOptionDone ==
    document.querySelector(".color .color-options span:nth-child(2)")
  ) {
    primary = 52;
  }
  if (
    colorOptionDone ==
    document.querySelector(".color .color-options span:nth-child(3)")
  ) {
    primary = 352;
  }
  if (
    colorOptionDone ==
    document.querySelector(".color .color-options span:nth-child(4)")
  ) {
    primary = 152;
  }
  if (
    colorOptionDone ==
    document.querySelector(".color .color-options span:nth-child(5)")
  ) {
    primary = 202;
  }
